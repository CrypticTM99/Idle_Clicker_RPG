...
let goldPerClick = 1;
let totalClicks = 0;
let tavernUpgrades = { goldBoost: 1, heroBoost: 1 };  // New variable for Tavern upgrades
...
const heroData = [
    { name: "Swordman", cost: 100, goldPerSecond: 5, idleDamage: 5 },
    { name: "Archer", cost: 400, goldPerSecond: 10, idleDamage: 14 },
    { name: "Mage", cost: 600, goldPerSecond: 20, idleDamage: 28 },
];
...
// This code is created by CrypticTM. All rights reserved. Keep clicking for more gold and upgrades!
